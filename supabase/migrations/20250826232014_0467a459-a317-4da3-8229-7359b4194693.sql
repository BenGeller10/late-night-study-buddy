...
INSERT INTO subjects (id, name, code) VALUES
  ('subj-math-295', 'Calculus I', 'MATH 295'),
  ('subj-math-296', 'Calculus II', 'MATH 296'),
  ('subj-phy-211', 'General Physics I', 'PHY 211'),
  ('subj-cas-132', 'Public Speaking', 'CAS 132'),
  ('subj-cis-252', 'Introduction to Computer Science', 'CIS 252'),
  ('subj-cis-351', 'Data Structures', 'CIS 351'),
  ('subj-cis-375', 'Database Systems', 'CIS 375'),
  ('subj-mat-331', 'Discrete Mathematics', 'MAT 331'),
  ('subj-che-275', 'Organic Chemistry I', 'CHE 275'),
  ('subj-che-276', 'Organic Chemistry II', 'CHE 276'),
  ('subj-bio-121', 'General Biology I', 'BIO 121'),
  ('subj-bio-123', 'General Biology II', 'BIO 123'),
  ('subj-ecn-203', 'Macroeconomics', 'ECN 203'),
  ('subj-ecn-301', 'Microeconomics', 'ECN 301'),
  ('subj-acc-151', 'Accounting Principles', 'ACC 151'),
  ('subj-fin-256', 'Corporate Finance', 'FIN 256'),
  ('subj-psy-205', 'Introduction to Psychology', 'PSY 205'),
  ('subj-psy-315', 'Research Methods', 'PSY 315'),
  ('subj-soc-101', 'Introduction to Sociology', 'SOC 101'),
  ('subj-ant-111', 'Cultural Anthropology', 'ANT 111'),
  ('subj-eng-105', 'Composition I', 'ENG 105'),
  ('subj-eng-205', 'Composition II', 'ENG 205'),
  ('subj-wrt-105', 'Studio 1', 'WRT 105'),
  ('subj-wrt-205', 'Studio 2', 'WRT 205'),
  ('subj-che-106', 'General Chemistry I', 'CHE 106'),
  ('subj-che-116', 'General Chemistry II', 'CHE 116'),
  ('subj-phy-101', 'Physics for Non-Majors', 'PHY 101'),
  ('subj-his-101', 'World History I', 'HIS 101'),
  ('subj-his-111', 'World History II', 'HIS 111'),
  ('subj-geo-155', 'Human Geography', 'GEO 155'),
  ('subj-psc-121', 'American Government', 'PSC 121')
ON CONFLICT (id) DO NOTHING;
...
('11111111-1111-1111-1111-111111111111', 'subj-math-295', 45),
('11111111-1111-1111-1111-111111111111', 'subj-math-296', 45),
('11111111-1111-1111-1111-111111111111', 'subj-phy-211', 42),
('11111111-1111-1111-1111-111111111111', 'subj-cas-132', 35),
-- Marcus Johnson - CS subjects
('22222222-2222-2222-2222-222222222222', 'subj-cis-252', 38),
('22222222-2222-2222-2222-222222222222', 'subj-cis-351', 40),
('22222222-2222-2222-2222-222222222222', 'subj-cis-375', 42),
('22222222-2222-2222-2222-222222222222', 'subj-mat-331', 35),
-- Emma Rodriguez - Science subjects
('33333333-3333-3333-3333-333333333333', 'subj-che-275', 48),
('33333333-3333-3333-3333-333333333333', 'subj-che-276', 48),
('33333333-3333-3333-3333-333333333333', 'subj-bio-121', 42),
('33333333-3333-3333-3333-333333333333', 'subj-bio-123', 42),
-- David Kim - Business subjects
('44444444-4444-4444-4444-444444444444', 'subj-ecn-203', 35),
('44444444-4444-4444-4444-444444444444', 'subj-ecn-301', 38),
('44444444-4444-4444-4444-444444444444', 'subj-acc-151', 32),
('44444444-4444-4444-4444-444444444444', 'subj-fin-256', 40),
-- Jessica Park - Psychology subjects
('55555555-5555-5555-5555-555555555555', 'subj-psy-205', 40),
('55555555-5555-5555-5555-555555555555', 'subj-psy-315', 45),
('55555555-5555-5555-5555-555555555555', 'subj-soc-101', 35),
('55555555-5555-5555-5555-555555555555', 'subj-ant-111', 35),
-- Michael Thompson - English subjects
('66666666-6666-6666-6666-666666666666', 'subj-eng-105', 30),
('66666666-6666-6666-6666-666666666666', 'subj-eng-205', 32),
('66666666-6666-6666-6666-666666666666', 'subj-wrt-105', 30),
('66666666-6666-6666-6666-666666666666', 'subj-wrt-205', 32),
-- Aisha Patel - Chemistry/Engineering subjects
('77777777-7777-7777-7777-777777777777', 'subj-che-106', 44),
('77777777-7777-7777-7777-777777777777', 'subj-che-116', 46),
('77777777-7777-7777-7777-777777777777', 'subj-math-295', 40),
('77777777-7777-7777-7777-777777777777', 'subj-phy-101', 38),
-- Ryan Mitchell - History/Political Science subjects
('88888888-8888-8888-8888-888888888888', 'subj-his-101', 32),
('88888888-8888-8888-8888-888888888888', 'subj-his-111', 32),
('88888888-8888-8888-8888-888888888888', 'subj-geo-155', 30),
('88888888-8888-8888-8888-888888888888', 'subj-psc-121', 35)
