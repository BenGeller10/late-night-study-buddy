-- Create trigger to automatically set up new user profiles and data
-- This was missing from the database setup
CREATE TRIGGER on_auth_user_created
  AFTER INSERT ON auth.users
  FOR EACH ROW EXECUTE FUNCTION public.handle_new_user();

-- Ensure all user-related data starts at zero for new accounts
