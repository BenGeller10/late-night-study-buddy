...
DROP TRIGGER IF EXISTS audit_payouts_trigger ON public.payouts CASCADE;
DROP FUNCTION IF EXISTS public.audit_payout_changes() CASCADE;
DROP FUNCTION IF EXISTS public.log_sensitive_access(text, text, uuid, jsonb, jsonb) CASCADE;  
DROP FUNCTION IF EXISTS public.cleanup_old_search_queries() CASCADE;
