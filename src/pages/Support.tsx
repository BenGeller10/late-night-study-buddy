...
const Support = () => {
  ...
  useEffect(() => {
    ...
    setMessages([
      {
        id: '1',
        content: "Hi! I'm your Campus Connect support agent. How can I help you today? Whether you need help with finding tutors, booking sessions, or have technical questions, I'm here to assist! 😊",
        isAI: true,
        timestamp: new Date()
      }
    ]);
